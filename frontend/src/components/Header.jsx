    ...
    <header className="bg-blue-600 shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-4 py-3 md:px-6">
        ...
        <Link to="/" className="flex items-center gap-2 text-white">
          ...
          <span className="text-lg md:text-2xl font-semibold">Task Manager</span>
        </Link>
        ...
        <div className="flex items-center gap-3">
          {!userinfo?.email ? (
            ...
            <Button
              onClick={() => mutation.mutate()}
              className="bg-slate-700 hover:bg-slate-600 text-white px-4 py-2 rounded-lg font-medium transition-all duration-200 shadow-sm"
            >
              Logout
            </Button>
